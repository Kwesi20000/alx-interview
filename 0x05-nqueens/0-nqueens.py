#!/usr/bin/python3
"""
A N queens solution finder module.
"""
import sys
...
def get_input():
    ...
    Returns:
        int: returns the size of the chessboard.
    """
    global n
    n = 0
    if len(sys.argv) != 2:
...
def is_attacking(pos0, pos1):
    """
    function checks if the positions of two queens are in an attacking mode.
...
def group_exists(group):
    """
    This checks if a group exists in the list of solutions.
...
def build_solution(row, group):
    """
    function builds a solution for the n queens problem.
...
def get_solutions():
    """
    function gets the solutions for the given chessboard size.
    """
    global pos, n
