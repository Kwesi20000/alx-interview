#!/usr/bin/python3
"""
A module that provides a function for determining if
...
def canUnlockAll(boxes):
    """
    A function to check whether all boxes can be opened by list of keyes

    box (list):list of lists containing keys reps boxes.

    returns:
        bool: True if all boxes can be opened or else False.
    """
    n = len(boxes)
    checked_boxes = set([0])
